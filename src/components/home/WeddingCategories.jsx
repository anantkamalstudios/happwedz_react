...
//           imageSrc: `${API_BASE_URL}${cat.hero_image}`,
...
//   if (loading) {
//     return <div className="container py-5 text-center">Loading categories...</div>;
//   }
                  ...
                  {isExpanded && (
                    <div className="wcg-subcats mt-3">
                      <div className="row g-2">
                        {cat.items.map((it, idx) => (
                          <div key={idx} className="col-6">
                            <Link to={`/${cat.slug}`} className="wedding-link small">
                              {it}
                            </Link>
                          </div>
                        ))}

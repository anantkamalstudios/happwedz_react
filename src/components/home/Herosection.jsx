                ...
                <Row className="justify-content-center mt-4">
                    <Col xs={12} md={10}>
                        <Form className="search-form d-flex flex-column flex-sm-row gap-3">
                            ...
                            <Form.Group className="flex-fill m-0">
                                <Form.Select aria-label="Select Category" className="form-control-lg"
                                    style={{ fontSize: "14px", padding: "0.5rem 0.75rem" }}>
                                    {categories.map((c) => (
                            ...
                            <Form.Group className="flex-fill m-0">
                                <Form.Select aria-label="Select Location" className="form-control-lg"
                                    style={{ fontSize: "14px", padding: "0.5rem 0.75rem" }}>
                                    {locations.map((l) => (
                            ...
                            <Button
                                variant="none"
                                className="btn-find px-4 text-white fw-semibold"
                                type="submit"
                            >
                                FIND VENDOR
                            </Button>

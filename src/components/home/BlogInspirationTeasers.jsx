...
const blogsCarousel = () => {
    ...
    return (
        <div className="wedding-blog-section py-3 px-3" style={{
            ...
            <div className="container position-relative" style={{ zIndex: 10 }}>
                ...
                >
                    {blogs.map((blogs, i) => (
                        <SwiperSlide key={i}>
                            <div className="blog-blogs h-100 rounded-4 overflow-hidden position-relative shadow-lg" style={{
                                background: '#fff',
                                transition: 'all 0.4s ease',
                                transform: activeIndex === i ? 'scale(1.02)' : 'scale(0.98)',
                                ...
                                <div className="position-relative overflow-hidden" style={{ height: '250px' }}>
                                    ...
                                    />
                                    <div className="position-absolute top-0 start-0 w-100 h-100" style={{
                                        background: 'linear-gradient(0deg, rgba(138,90,118,0.5) 0%, rgba(138,90,118,0) 50%)'
                                    }}></div>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="d-flex align-items-center mb-3">
                                        <div className="d-flex align-items-center me-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#b57e9f" viewBox="0 0 16 16" className="me-1">

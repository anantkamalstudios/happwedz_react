                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav me-auto">
                        <li className="nav-item">
                            <Link
                                className={`nav-link ${location.pathname === '/einvites' ? 'active' : ''}`}
                                to="/einvites"
                            >
                                Browse Templates
                            </Link>
                        ...
                        <li className="nav-item">
                            <Link
                                className={`nav-link ${location.pathname === '/einvites/my-cards' ? 'active' : ''}`}
                    ...
                    <div className="d-flex">
                        <Link className="btn btn-outline-primary me-2" to="/einvites/create">
                            Create New
                        </Link>

        ...
        <div className="filter-section">
          <div className="d-flex justify-content-between align-items-center mb-2">
            <h6
              ...
              onClick={() => toggleSection("BridalMehndi")}
            >
              {renderIcon(sectionState.BridalMehndi)} Bridal Mehndi
            </h6>
          </div>
          {sectionState.BridalMehndi &&
            renderCheckboxList("venue", FILTER_OPTIONS.BridalMehndi)}
        </div>

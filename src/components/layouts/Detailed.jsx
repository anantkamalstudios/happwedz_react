...
const extractMainCity = (rawCity) => {
  ...
  if (
    cleaned.toLowerCase().includes("location not specified") ||
  ...
  if (parts.length > 1) {
    ...
    if (
      candidate &&
      !candidate.toLowerCase().includes("location not specified") &&
...
const Detailed = () => {
  ...
  const getVendorFeatures = (data) => {
    ...
    const sangeetChoreographerMaster =
      attributes.sangeet_choreographer_master || {};
    const weddingEntertainerMaster =
      attributes.wedding_entertainer_master || {};
    const preWeddingLocationMaster =
      attributes.pre_wedding_location_master || {};
    const preWeddingPhotographerMaster =
    ...
    if (
      ...
      attributes.rooms ||
      Object.keys(venueMaster).length > 0
    ) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Premium & Experience",
        formatList(vc.premium),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Location Based",
        formatList(vc.locationBased),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Capacity Based",
        formatList(vc.capacityBased),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Budget Based",
        formatList(vc.budgetBased),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Function Specific",
        formatList(vc.functionSpecific),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Facility Based",
        formatList(vc.facilityBased),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Booking & Usage",
        formatList(vc.bookingFlex),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Trend & Modern",
        formatList(vc.trendModern),
      );
      ...
      pushFeature(
        ...
        <FaMapMarkerAlt />,
        "Property Ownership",
        vIdentity.property_ownership === "Other"
          ? vIdentity.property_ownership_other
          : vIdentity.property_ownership,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Years of Operation",
        vIdentity.years_of_operation,
      );
      pushFeature(
        amenities,
        <FaMapMarkerAlt />,
        "Location Type",
        vIdentity.location_type === "Other"
          ? vIdentity.location_type_other
          : vIdentity.location_type,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Chain Property",
        vIdentity.chain_property,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Brand Name",
        vIdentity.chain_brand_name,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Brand Category",
        vIdentity.chain_brand_category === "Other"
          ? vIdentity.chain_brand_category_other
          : vIdentity.chain_brand_category,
      );
      ...
      if (vSpace.space_types_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Space Types",
          vSpace.space_types_other,
        );
      pushFeature(
        amenities,
        <FaStar />,
        "Total Event Spaces",
        vSpace.num_event_spaces,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Indoor Spaces",
        vSpace.indoor_spaces_count,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Outdoor Spaces",
        vSpace.outdoor_spaces_count,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Indoor Seating",
        vSpace.indoor_seating,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Indoor Floating",
        vSpace.indoor_floating,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Outdoor Seating",
        vSpace.outdoor_seating,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Outdoor Floating",
        vSpace.outdoor_floating,
      );
      ...
      pushFeature(
        ...
        vSpace.separate_function_areas,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Simultaneous Events",
        vSpace.multiple_events_simultaneous,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Exclusive Booking",
        vSpace.exclusive_booking,
      );
      ...
      pushFeature(
        ...
        <FaBed />,
        "Number of Rooms",
        vRooms.num_rooms || attributes.rooms,
      );
      pushFeature(
        amenities,
        <FaBed />,
        "Max Occupancy Per Room",
        vRooms.max_occupancy_per_room,
      );
      pushFeature(
        amenities,
        <FaBed />,
      ...
      pushFeature(
        ...
        <FaBed />,
        "Room Price Range",
        vRooms.room_price_range === "Other"
          ? vRooms.room_price_range_other
          : vRooms.room_price_range,
      );
      pushFeature(
        amenities,
        <FaBed />,
        "Complimentary Rooms",
        vRooms.complimentary_rooms,
      );
      pushFeature(
        amenities,
        <FaBed />,
        "Total Stay Capacity",
        vRooms.total_stay_capacity,
      );
      pushFeature(
        amenities,
        <FaBed />,
        "Room Types",
        formatList(vRooms.room_types),
      );
      if (vRooms.room_types_other)
        pushFeature(
          amenities,
          <FaBed />,
          "Other Room Types",
          vRooms.room_types_other,
        );
      if (
        vRooms.room_type_counts &&
        typeof vRooms.room_type_counts === "object"
      ) {
      ...
      pushFeature(
        ...
        <FaUtensils />,
        "Catering Policy",
        vFood.catering_policy === "Other"
          ? vFood.catering_policy_other
          : vFood.catering_policy || attributes.catering_policy,
      );
      pushFeature(
        amenities,
        <FaUtensils />,
        "Veg/Non-Veg",
        vFood.veg_non_veg === "Other"
          ? vFood.veg_non_veg_other
          : vFood.veg_non_veg,
      );
      pushFeature(
        amenities,
        <FaUtensils />,
        "Cuisine",
        formatList(vFood.cuisines, 15),
      );
      if (vFood.cuisines_other)
        pushFeature(
          amenities,
          <FaUtensils />,
          "Other Cuisines",
          vFood.cuisines_other,
        );
      ...
      pushFeature(
        ...
        <FaUtensils />,
        "Per Plate Cost",
        vFood.per_plate_cost_range === "Other"
          ? vFood.per_plate_cost_range_other
          : vFood.per_plate_cost_range,
      );
      pushFeature(
        amenities,
        <FaUtensils />,
        "Outside Catering Charges",
        vFood.outside_catering_charges === "Other"
          ? vFood.outside_catering_charges_other
          : vFood.outside_catering_charges,
      );
      pushFeature(
        amenities,
        <FaUtensils />,
        "Kitchen for External Caterer",
        vFood.kitchen_for_external,
      );
      ...
      pushFeature(
        ...
        <FaGlassCheers />,
        "Alcohol Policy",
        vAlcohol.policy === "Other"
          ? vAlcohol.policy_other
          : vAlcohol.policy || attributes.alcohol_policy,
      );
      pushFeature(
        amenities,
        <FaGlassCheers />,
        "Corkage Charges",
        vAlcohol.corkage === "Other"
          ? vAlcohol.corkage_other
          : vAlcohol.corkage,
      );
      pushFeature(
        amenities,
        <FaGlassCheers />,
        "Bar Setup",
        formatList(vAlcohol.bar_setup),
      );
      if (vAlcohol.bar_setup_other)
        pushFeature(
          amenities,
          <FaGlassCheers />,
          "Other Bar Setup",
          vAlcohol.bar_setup_other,
        );
      pushFeature(
        amenities,
        <FaGlassCheers />,
      ...
      pushFeature(
        ...
        vDecor.policy === "Other"
          ? vDecor.policy_other
          : vDecor.policy || attributes.decor_policy,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Decor Capabilities",
        formatList(vDecor.capabilities, 10),
      );
      if (vDecor.capabilities_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Capabilities",
          vDecor.capabilities_other,
        );
      pushFeature(
        amenities,
        <FaStar />,
        "Stage Decor",
        formatList(vDecor.stage),
      );
      if (vDecor.stage_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Stage Decor",
      ...
      pushFeature(
        ...
        <FaStar />,
        "Mandap Decor",
        formatList(vDecor.mandap),
      );
      if (vDecor.mandap_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Mandap Decor",
      ...
      pushFeature(
        ...
        <FaStar />,
        "Lighting Setup",
        formatList(vDecor.lighting),
      );
      if (vDecor.lighting_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Lighting",
          vDecor.lighting_other,
        );
      pushFeature(
        amenities,
        <FaStar />,
        "Sound System",
        formatList(vDecor.sound),
      );
      if (vDecor.sound_other)
        pushFeature(amenities, <FaStar />, "Other Sound", vDecor.sound_other);
      pushFeature(
        amenities,
        <FaStar />,
        "Outside Decor Charges",
        vDecor.outside_charges === "Other"
          ? vDecor.outside_charges_other
          : vDecor.outside_charges,
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "DJ Policy",
        vEntertainment.dj_policy === "Other"
          ? vEntertainment.dj_policy_other
          : vEntertainment.dj_policy || attributes.dJ_policy,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Noise Restriction",
        vEntertainment.noise === "Other"
          ? vEntertainment.noise_other
          : vEntertainment.noise,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Live Band Available",
        vEntertainment.live_band,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Fireworks Allowed",
        vEntertainment.fireworks === "Other"
          ? vEntertainment.fireworks_other
          : vEntertainment.fireworks,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Entertainment Supported",
        formatList(vEntertainment.supported, 10),
      );
      if (vEntertainment.supported_other)
        pushFeature(
          amenities,
          <FaCalendarAlt />,
          "Other Entertainment",
          vEntertainment.supported_other,
        );
      ...
      pushFeature(
        ...
        <FaParking />,
        "Parking Available",
        vFacilities.parking || attributes.parking,
      );
      pushFeature(
        amenities,
        <FaParking />,
        "Parking Capacity",
        vFacilities.parking_capacity,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Power Backup",
        formatList(vFacilities.power_backup),
      );
      if (vFacilities.power_backup_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Power Backup",
          vFacilities.power_backup_other,
        );
      pushFeature(
        amenities,
        <FaStar />,
        "Air Conditioning",
        vFacilities.ac === "Other" ? vFacilities.ac_other : vFacilities.ac,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Bridal Room",
        vFacilities.bridal_room,
      );
      ...
      pushFeature(
        ...
        vFacilities.wheelchair,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Washroom Quality",
        vFacilities.washroom === "Other"
          ? vFacilities.washroom_other
          : vFacilities.washroom,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Security Services",
        vFacilities.security === "Other"
          ? vFacilities.security_other
          : vFacilities.security,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Additional Facilities",
        formatList(vFacilities.additional, 10),
      );
      if (vFacilities.additional_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Facilities",
          vFacilities.additional_other,
        );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Pricing Model",
        formatList(vPricing.pricing_model),
      );
      if (vPricing.pricing_model_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Pricing Model",
          vPricing.pricing_model_other,
        );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Peak Season Pricing",
        vPricing.peak_season_pricing,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Advance Booking Required",
        vPricing.advance_booking_required,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Advance Payment Range",
        vPricing.advance_payment_range === "Other"
          ? vPricing.advance_payment_range_other
          : vPricing.advance_payment_range,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Min Booking Duration",
        formatList(vPricing.min_booking_duration),
      );
      if (vPricing.min_booking_duration_other)
        pushFeature(
          amenities,
          <FaStar />,
          "Other Min Duration",
          vPricing.min_booking_duration_other,
        );
      pushFeature(
        amenities,
        <FaStar />,
        "Cancellation Policy",
        vPricing.cancellation === "Other"
          ? vPricing.cancellation_other
          : vPricing.cancellation || attributes.cancellation_policy,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Refund Timeline",
        vPricing.refund_timeline === "Other"
          ? vPricing.refund_timeline_other
          : vPricing.refund_timeline,
      );
      ...
      pushFeature(
        ...
        <FaUsers />,
        "Suitable For",
        formatList(vSuitability.suitable_for, 20),
      );
      if (vSuitability.suitable_for_other)
        pushFeature(
          amenities,
          <FaUsers />,
          "Other Suitable For",
          vSuitability.suitable_for_other,
        );
      pushFeature(
        amenities,
        <FaUsers />,
        "Best For",
        formatList(vSuitability.best_for, 10),
      );
      if (vSuitability.best_for_other)
        pushFeature(
          amenities,
          <FaUsers />,
          "Other Best For",
          vSuitability.best_for_other,
        );
      pushFeature(
        amenities,
        <FaUsers />,
        "Ideal Guest Range",
        formatList(vSuitability.ideal_guest_range),
      );
      if (vSuitability.ideal_guest_range_other)
        pushFeature(
          amenities,
          <FaUsers />,
          "Other Guest Range",
          vSuitability.ideal_guest_range_other,
        );
    }
    ...
    if (catererMaster && Object.keys(catererMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaMapMarkerAlt />,
        "Service Locations",
        formatList(ci.service_locations),
      );
      ...
      pushFeature(
        ...
        <FaUtensils />,
        "Catering Style",
        formatList(cs.catering_style),
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Event Types Covered",
        formatList(cs.event_types_covered),
      );
      ...
      pushFeature(
        ...
        formatList(cs.special_dietary_options),
      );
      ...
      pushFeature(
        ...
        <FaUtensils />,
        "Cuisine Types",
        formatList(cc.cuisine_types, 15),
      );
      pushFeature(
        amenities,
        <FaUtensils />,
      ...
      pushFeature(
        ...
        cm.custom_menu_available,
      );
      pushFeature(
        amenities,
        <FaUtensils />,
        "Menu Tasting Available",
        cm.menu_tasting_available,
      );
      ...
      pushFeature(
        ...
        <FaUtensils />,
        "Menu Items Offered",
        cm.menu_items_offered,
      );
      pushFeature(
        amenities,
        <FaUtensils />,
        "Live Counters Available",
        cm.live_counters_available,
      );
      pushFeature(
        amenities,
        <FaUtensils />,
        "Popular Live Counters",
        formatList(cm.popular_live_counters),
      );
      ...
      pushFeature(
        amenities,
        <FaStar />,
        "Per Plate Starting Price",
        cp.per_plate_starting_price,
      );
      ...
      pushFeature(
        ...
        <FaUtensils />,
        "Utensils & Crockery",
        cie.utensils_crockery,
      );
      pushFeature(
        amenities,
        <FaUtensils />,
        "Eco-Friendly Options",
        cie.eco_friendly_options,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Hygiene Standards",
        formatList(chq.hygiene_standards),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Food Quality Assurance",
        chq.food_quality_assurance,
      );
      ...
      pushFeature(
        amenities,
        <FaMapMarkerAlt />,
        "Outdoor Catering Supported",
        cl.outdoor_catering_supported,
      );
      pushFeature(
        amenities,
        <FaMapMarkerAlt />,
        "Destination Weddings Supported",
        cl.destination_weddings_supported,
      );
      pushFeature(
        amenities,
        <FaMapMarkerAlt />,
      ...
      pushFeature(
        ...
        formatList(ces.functions_suitable_for, 15),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Advance Required",
        cwb.advance_required,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Advance Percentage",
        cwb.advance_percentage,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Booking Timeline",
        cwb.booking_timeline,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Cancellation Policy",
        cwb.cancellation_policy,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
    ...
    if (photographerMaster && Object.keys(photographerMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Best Known For",
        formatList(ps.best_known_for, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaMapMarkerAlt />,
        "Travel Availability",
        pi.travel_availability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Also Available For",
        pi.also_available_for,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Years of Experience",
        pi.years_of_experience,
      );
      ...
      pushFeature(
        ...
        <FaUsers />,
        "Max Events Per Day",
        pt.max_events_per_day,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Backup Team",
        pt.backup_team_available,
      );
      pushFeature(
        amenities,
        <FaUsers />,
      ...
      pushFeature(amenities, <FaStar />, "Drone Available", pe.drone_available);
      pushFeature(
        amenities,
        <FaStar />,
    ...
    if (makeupArtistMaster && Object.keys(makeupArtistMaster).length > 0) {
      ...
      pushFeature(amenities, <FaStar />, "Cities", formatList(mi.cities, 4));
      pushFeature(
        amenities,
        <FaStar />,
        "Skin Tone Expertise",
    ...
    if (mehndiArtistMaster && Object.keys(mehndiArtistMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Services",
        formatList(srv.services_offered, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Coverage Type",
        formatList(srv.coverage_type, 3),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Mehendi Style",
        formatList(stl.mehendi_style, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Design Complexity",
        stl.design_complexity,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Best Known For",
        formatList(stl.best_known_for, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Custom Designs",
        stl.custom_designs_available,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Personalization",
        formatList(stl.personalization_options, 4),
      );
      ...
      if (brd.bridal_starting_price) {
        pushFeature(
          amenities,
          <FaStar />,
          "Bridal Starting Price",
          `₹${brd.bridal_starting_price}`,
        );
      }
      ...
      pushFeature(
        ...
        <FaUsers />,
        "Max Guests Covered",
        gst.max_guests_covered,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Guest Pricing Model",
        gst.guest_pricing_model,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Team Support for Guests",
        gst.team_support_for_guests,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Aftercare Provided",
        mat.aftercare_instructions_provided,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Allergies Consideration",
        mat.allergies_consideration,
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Functions Covered",
        formatList(evt.functions_covered, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Best For",
        formatList(evt.best_for, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Application Speed",
        spd.application_speed,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Parallel Artists",
        spd.parallel_artists_available,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Multiple Events Handling",
        spd.multiple_events_handling,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Stay Requirement",
        prc.stay_requirement,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Min Booking Value",
        prc.minimum_booking_value,
      );
    ...
    if (floristMaster && Object.keys(floristMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaMapMarkerAlt />,
        "Service Presence",
        formatList(id.service_presence, 3),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Store Presence",
        formatList(id.store_presence, 3),
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Specialization",
        formatList(id.specialization, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Service Types",
        formatList(srv.service_types, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Customization",
        srv.customization_available,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Same Day Delivery",
        srv.same_day_delivery,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Subscription Services",
        srv.subscription_services,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Bulk Orders",
        srv.bulk_order_handling,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Event Setup",
        srv.event_setup_support,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Packaging",
        formatList(srv.packaging_options, 3),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Flower Types",
        formatList(core.flower_types_available, 7),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Usage Types",
        formatList(core.usage_types, 6),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Color Palette",
        formatList(core.color_palette, 6),
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Seasonal Availability",
        core.seasonal_availability,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Freshness Guarantee",
        tech.flower_freshness_guarantee,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Sourcing",
        formatList(tech.sourcing_type, 3),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Arrangements",
        formatList(tech.arrangement_types, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Eco-Friendly",
        tech.eco_friendly_options,
      );
      ...
      pushFeature(
        ...
        scale.daily_order_capacity,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Event Capacity",
        scale.event_handling_capacity,
      );
      ...
      pushFeature(
        ...
        wf.customization_approval_process,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Delivery Time Slots",
        wf.delivery_time_slots,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Payment Modes",
        formatList(wf.payment_modes, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Advance Payment",
        wf.advance_payment_percentage,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Style Tags",
        formatList(ptag.style_tags, 5),
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Audience Tags",
        formatList(ptag.audience_tags, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Usage Tags",
        formatList(ptag.usage_tags, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Price Segment",
        ptag.price_segment_tags,
      );
    }
    ...
    if (panditMaster && Object.keys(panditMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaMapMarkerAlt />,
        "Service Presence",
        formatList(id.service_presence, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Languages",
        formatList(id.languages_spoken, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Tradition",
        formatList(id.religious_tradition, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Ceremonies",
        formatList(srv.ceremony_types, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Destination Wedding",
        srv.destination_wedding_services,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Virtual Ceremony",
        srv.virtual_ceremony_support,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Ritual Explanation",
        srv.ritual_explanation_provided,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Custom Rituals",
        srv.customized_rituals,
      );
      ...
      pushFeature(
        ...
        <FaUsers />,
        "Assistant Pandits",
        srv.assistant_pandits_included,
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Ritual Duration",
        core.ritual_duration_options,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Complexity",
        core.ritual_complexity_level,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Muhurat Guidance",
        core.muhurat_guidance_provided,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Horoscope Matching",
        core.horoscope_matching,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Language Preference",
        formatList(core.ritual_language_preference, 3),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Havan Included",
        core.fire_ritual_havan_included,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Interfaith Ceremonies",
        core.interfaith_custom_ceremonies,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Audio Setup",
        tech.audio_setup_requirement,
      );
      pushFeature(amenities, <FaStar />, "Mic Usage", tech.microphone_usage);
      pushFeature(
        amenities,
        <FaStar />,
        "Samagri List Advance",
        tech.samagri_list_provided_in_advance,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Setup Time",
        tech.setup_time_required,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Dress Code",
        tech.dress_code_provided,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Ritual Booklet",
        tech.documentation_ritual_booklet,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Pre-consultation",
        wf.pre_ceremony_consultation,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Customization Discussion",
        wf.ritual_customization_discussion,
      );
    ...
    if (djMaster && Object.keys(djMaster).length > 0) {
      ...
      const id =
        Object.keys(djMaster.identity || {}).length > 0
          ? djMaster.identity
          : {
      ...
      const srv =
        Object.keys(djMaster.services || {}).length > 0
          ? djMaster.services
          : {
      ...
      const core =
        Object.keys(djMaster.core_intelligence || {}).length > 0
      ...
      const tech =
        Object.keys(djMaster.technical_setup || {}).length > 0
      ...
      const prc =
        Object.keys(djMaster.pricing || {}).length > 0
          ? djMaster.pricing
          : {
      ...
      const scale =
        Object.keys(djMaster.scale_capacity || {}).length > 0
      ...
      const wf =
        Object.keys(djMaster.workflow || {}).length > 0
          ? djMaster.workflow
          : {
      ...
      const ptag =
        Object.keys(djMaster.portfolio_tagging || {}).length > 0
          ...
          : {
              ...
              celebrity_big_event_experience:
                djMaster.celebrity_big_event_experience,
            };
      ...
      pushFeature(
        ...
        <FaMapMarkerAlt />,
        "Service Cities",
        formatList(id.service_cities, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Event Types Covered",
        formatList(srv.event_types, 6),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "DJ Formats",
        formatList(srv.dj_formats, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Additional Services",
        formatList(srv.additional_services, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Music Genres",
        formatList(core.music_genres, 6),
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Crowd Handling Capability",
        core.crowd_handling,
      );
      pushFeature(
        amenities,
        ...
        core.specialization_style,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Live Mixing Capability",
        core.live_mixing_capability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Custom Playlist Support",
        core.custom_playlist_support,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Song Request Handling",
        core.song_request_handling,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Entry & Performance Sync",
        formatList(core.entry_sync, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Baraat DJ Setup",
        core.baraat_dj_setup,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Backup DJ Available",
        core.backup_dj_available,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Equipment Ownership",
        tech.equipment_ownership,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Sound Setup Capability",
        tech.sound_setup_capability,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Console Types",
        formatList(tech.console_types, 4),
      );
      ...
      pushFeature(
        ...
        prc.starting_price_range,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Includes",
        formatList(prc.includes, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Add-on Charges",
        formatList(prc.addon_charges, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Peak Season Pricing",
        prc.peak_season_pricing,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Negotiation Flexibility",
        prc.negotiation_flexibility,
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Max Events Per Day",
        scale.max_events_per_day,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Concurrent Events",
        scale.concurrent_events,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Team-based Multi-event",
        scale.team_multi_event,
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Advance Booking",
        wf.advance_booking_time,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Booking Advance Percentage",
        wf.booking_advance_percent,
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        amenities,
        <FaStar />,
        "Client Coordination Mode",
        wf.coordination_mode,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Pre-event Planning Call",
        wf.pre_event_planning_call,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Event Mood Tags",
        formatList(ptag.event_mood_tags, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Music Style Tags",
        formatList(ptag.music_style_tags, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Celebrity/Big Event Experience",
        ptag.celebrity_big_event_experience,
      );
    }

    // --- SANGEET CHOREOGRAPHER MASTER ATTRIBUTES ---
    if (
      sangeetChoreographerMaster &&
      Object.keys(sangeetChoreographerMaster).length > 0
    ) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Dance Formats",
        formatList(srv.dance_formats, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Special Offerings",
        formatList(srv.special_offerings, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Dance Styles",
        formatList(core.dance_styles, 6),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Skill Level Handling",
        core.skill_level_handling,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Age Group Handling",
        formatList(core.age_group_handling, 4),
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Max Participants",
        core.max_participants_per_act,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Story-based Choreography",
        core.story_based_choreography,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Customization Level",
        core.customization_level,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Music Selection Support",
        core.music_selection_support,
      );
      pushFeature(amenities, <FaStar />, "Rehearsal Mode", core.rehearsal_mode);
      pushFeature(
        amenities,
        <FaStar />,
        "Performance Polish Level",
        core.performance_polish_level,
      );

      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Rehearsal Sessions per Act",
        rehearsal.rehearsal_sessions_per_act,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Session Duration",
        rehearsal.session_duration,
      );
      pushFeature(
        amenities,
        <FaMapMarkerAlt />,
        "Practice Location",
        rehearsal.practice_location,
      );
      pushFeature(
        amenities,
        <FaMapMarkerAlt />,
        "Travel for Practice",
        rehearsal.travel_for_practice,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Assistant Availability",
        rehearsal.assistant_availability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Last-minute Practice Support",
        rehearsal.last_minute_practice_support,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "On-event Presence",
        exec.on_event_presence,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Backstage Coordination",
        exec.backstage_coordination,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Entry & Transition Planning",
        exec.entry_transition_planning,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Music Editing & Mixing",
        exec.music_editing_mixing,
      );
      ...
      pushFeature(
        ...
        formatList(ptag.performance_style_tags, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Event Scale Tags",
        formatList(ptag.event_scale_tags, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Choreography Style Tags",
        formatList(ptag.choreography_style_tags, 5),
      );
    }

    // --- WEDDING ENTERTAINER MASTER ATTRIBUTES ---
    if (
      weddingEntertainerMaster &&
      Object.keys(weddingEntertainerMaster).length > 0
    ) {
      ...
      const performerCat =
        id.performer_category === "Other"
          ? id.performer_category_other
          : id.performer_category;
      ...
      pushFeature(
        ...
        <FaStar />,
        "Performance Types",
        formatList(srv.performance_types, 5),
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Audience Type Handling",
        formatList(srv.audience_type_handling, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Engagement Style",
        core.engagement_style,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Performance Duration",
        core.performance_duration,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Performance Slots",
        core.performance_slots,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Content Customization",
        core.content_customization,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Theme Compatibility",
        formatList(core.theme_compatibility, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Stage Requirement",
        core.stage_requirement,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Sound Requirement",
        core.sound_requirement,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Lighting Requirement",
        core.lighting_requirement,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Power Requirement",
        tech.power_requirement,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Green Room Requirement",
        tech.green_room_requirement,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Outdoor Suitability",
        tech.outdoor_suitability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Indoor Suitability",
        tech.indoor_suitability,
      );
      ...
      pushFeature(
        amenities,
        <FaUsers />,
        "Audience Size Capability",
        scale.audience_size_capability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Multiple Event Handling",
        scale.multiple_event_handling,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Parallel Performances",
        scale.parallel_performances,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Entertainment Tags",
        formatList(ptag.entertainment_tags, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Performer Tags",
        formatList(ptag.performer_tags, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Event Fit Tags",
        formatList(ptag.event_fit_tags, 5),
      );
    }

    // --- PRE-WEDDING LOCATION MASTER ATTRIBUTES ---
    if (
      preWeddingLocationMaster &&
      Object.keys(preWeddingLocationMaster).length > 0
    ) {
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Booking Type",
        formatList(srv.booking_type, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Photography Allowed",
        srv.photography_allowed,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Videography Allowed",
        srv.videography_allowed,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Drone Usage Allowed",
        srv.drone_usage_allowed,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Permission Handling",
        srv.permission_handling,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Changing Rooms Available",
        srv.changing_rooms_available,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Makeup Room Available",
        srv.makeup_room_available,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Props Available",
        formatList(srv.props_available, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Power Supply Available",
        srv.power_supply_available,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Location Themes",
        formatList(core.location_themes, 5),
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Best Shoot Time",
        formatList(core.best_shoot_time, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Lighting Conditions",
        core.lighting_conditions,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Weather Suitability",
        formatList(core.weather_suitability, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Indoor Availability",
        tech.indoor_availability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Outdoor Availability",
        tech.outdoor_availability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Terrain Type",
        formatList(tech.terrain_type, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Electric Backup",
        tech.electric_backup,
      );
      ...
      pushFeature(
        ...
        <FaUsers />,
        "Simultaneous Shoots",
        scale.simultaneous_shoots,
      );
      pushFeature(
        amenities,
        <FaParking />,
        "Parking Capacity",
        scale.parking_capacity,
      );
      ...
      pushFeature(
        ...
        wf.time_slot_allocation,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Onsite Coordinator",
        wf.onsite_coordinator_available,
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Visual Style Tags",
        formatList(ptag.visual_style_tags, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
    ...
    if (
      preWeddingPhotographerMaster &&
      Object.keys(preWeddingPhotographerMaster).length > 0
    ) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Shoot Types",
        formatList(srv.shoot_types, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Photography Coverage",
        formatList(srv.photography_coverage, 4),
      );
      ...
      pushFeature(
        ...
        srv.cinematic_videography,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Concept Planning Support",
        srv.concept_planning_support,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Location Assistance",
        srv.location_assistance,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Styling Assistance",
        srv.styling_assistance,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Outfit Coordination Support",
        srv.outfit_coordination_support,
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Photography Style",
        formatList(core.photography_style, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Shoot Style Themes",
        formatList(core.shoot_style_themes, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Lighting Style",
        formatList(core.lighting_style, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Editing Style",
        formatList(core.editing_style, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Reel Style Capability",
        formatList(core.reel_style_capability, 4),
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Best Time Preference",
        formatList(core.best_time_preference, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Camera Type",
        formatList(tech.camera_type, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Drone Equipment Level",
        tech.drone_equipment_level,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Video Resolution",
        tech.video_resolution,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Stabilization Equipment",
        formatList(tech.stabilization_equipment, 4),
      );
      ...
      pushFeature(
        ...
        tech.backup_equipment_available,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Advance Payment",
        prc.advance_payment_percentage,
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Shoots Per Month",
        scale.shoots_per_month,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Simultaneous Projects",
        scale.simultaneous_projects,
      );
      pushFeature(
        amenities,
        <FaUsers />,
        "Team Scalability",
        scale.team_scalability,
      );
      ...
      pushFeature(
        ...
        wf.concept_finalization_timeline,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Shoot Duration Options",
        formatList(wf.shoot_duration_options, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Raw Data Delivery",
        wf.raw_data_delivery,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Edited Photos Delivery",
        wf.edited_photos_delivery_timeline,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Video Delivery Timeline",
        wf.video_delivery_timeline,
      );
      pushFeature(
        amenities,
        <FaStar />,
    ...
    if (jewelleryMaster && Object.keys(jewelleryMaster).length > 0) {
      ...
      pushFeature(
        ...
        formatList(jpc.complete_set_includes, 50),
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Rental Price Range",
        jrl.rental_price_range,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Security Deposit",
        jrl.security_deposit,
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        jai.multiple_pieces_available,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Availability Tracking",
        jai.realtime_availability_tracking,
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Best For",
        formatList(jes.best_for, 50),
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Advance Required",
        jwb.advance_required,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Advance Percentage",
        jwb.advance_percentage,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Cancellation",
        jwb.cancellation_policy,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
    ...
    if (
      jewelleryRentalMaster &&
      Object.keys(jewelleryRentalMaster).length > 0
    ) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Jewellery Types",
        formatList(jpc.jewellery_types, 50),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Complete Set Includes",
        formatList(jpc.set_includes, 50),
      );
    ...
    if (accessoriesMaster && Object.keys(accessoriesMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Experience",
        ai.years_of_experience ? `${ai.years_of_experience} years` : "",
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Accessories Types",
        formatList(apc.accessories_types, 6),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Bridal Accessories",
        apc.bridal_accessories,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Groom Accessories",
        apc.groom_accessories,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Style Categories",
        formatList(asd.style_categories, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Best Known For",
        formatList(asd.best_known_for, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Suitable For",
        formatList(asd.suitable_for, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Materials Used",
        formatList(amq.materials_used, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Functions Suitable For",
        formatList(aes.functions_suitable_for, 6),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Best For",
        formatList(aes.best_for, 4),
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Advance Required",
        awb.advance_required,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Advance Percentage",
        awb.advance_percentage,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Cancellation Policy",
        awb.cancellation_policy,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
    ...
    if (cocktailGownMaster && Object.keys(cocktailGownMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Experience",
        ci.years_of_experience ? `${ci.years_of_experience} years` : "",
      );
      pushFeature(
        amenities,
        <FaMapMarkerAlt />,
      ...
      pushFeature(
        ...
        <FaMapMarkerAlt />,
        "Service Cities",
        formatList(ci.service_cities, 4),
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Appointment",
        ci.appointment_requirement,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Design Style",
        formatList(pc.design_style, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Color Palette",
        formatList(pc.color_palette, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Silhouettes",
        formatList(core.silhouette_types, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Necklines",
        formatList(core.neckline_types, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Fabrics",
        formatList(core.fabric_options, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Embellishments",
        formatList(core.embellishment_types, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Body Type Styling",
        formatList(fs.body_type_styling, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Trial Availability",
        fs.trial_availability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Alteration Support",
        fs.alteration_support,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Styling Consultation",
        fs.styling_consultation,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Accessory Styling",
        fs.accessory_styling_support,
      );
      ...
      pushFeature(
        ...
        formatList(ou.occasion_suitability, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Starting Price",
        pl.starting_price_range,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Includes",
        formatList(pl.includes, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Delivery Options",
        formatList(pd.delivery_options, 4),
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Advance Booking",
        wb.advance_booking_time,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Booking Advance",
        wb.booking_advance_percent,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Cancellation Policy",
        wb.cancellation_policy,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Client Coordination",
        formatList(wb.client_coordination, 4),
      );
      ...
      pushFeature(
        ...
        <FaUsers />,
        "Bride Type Tags",
        formatList(ptag.bride_type_tags, 5),
      );
    }
    ...
    if (bridalOutfitMaster && Object.keys(bridalOutfitMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Experience",
        bi.years_of_experience ? `${bi.years_of_experience} years` : "",
      );
      pushFeature(
        amenities,
        <FaMapMarkerAlt />,
      ...
      pushFeature(
        ...
        <FaMapMarkerAlt />,
        "Service Cities",
        formatList(bi.service_cities, 4),
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Appointment",
        bi.appointment_requirement,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Outfit Types",
        formatList(bpc.lehenga_types, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Design Style",
        formatList(bpc.design_style, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Color Options",
        formatList(bpc.color_options, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Silhouettes",
        formatList(bci.silhouette_types, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Fabrics",
        formatList(bci.fabric_options, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Work Types",
        formatList(bci.work_types, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Body Type Styling",
        formatList(bfs.body_type_styling, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Trial Availability",
        bfs.trial_availability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Alteration Support",
        bfs.alteration_support,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Styling Consultation",
        bfs.styling_consultation,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Blouse Customization",
        bfs.blouse_customization,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Occasion Suitability",
        formatList(bou.occasion_suitability, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Starting Price",
        bpl.starting_price_range,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Includes",
        formatList(bpl.includes, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Delivery Options",
        formatList(bpd.delivery_options, 4),
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Advance Booking",
        bwb.advance_booking_time,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Booking Advance %",
        bwb.booking_advance_percent,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Cancellation Policy",
        bwb.cancellation_policy,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Client Coordination",
        formatList(bwb.client_coordination, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Outfit Tags",
        formatList(ptag.lehenga_tags, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
    ...
    if (rentalOutfitMaster && Object.keys(rentalOutfitMaster).length > 0) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Store Presence",
        formatList(ri.store_presence, 3),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Specialization",
        formatList(ri.inventory_specialization, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Rental Types",
        formatList(rs.rental_types, 3),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Trial Availability",
        rs.trial_availability,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Customization",
        rs.customization_alteration,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Styling Assistance",
        rs.styling_assistance,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Accessories Available",
        formatList(rs.accessory_rental, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Dry Cleaning",
        rs.dry_cleaning_included,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Pickup & Delivery",
        rs.pickup_delivery_service,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Urgent Rental",
        rs.urgent_rental_availability,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Lehenga Styles",
        formatList(rci.lehenga_styles, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Occasions",
        formatList(rci.occasion_suitability, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Work Types",
        formatList(rci.work_type, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Fabrics",
        formatList(rci.fabric_options, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Colors",
        formatList(rci.color_palette, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Designer Options",
        formatList(rci.designer_availability, 3),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Dupatta Styles",
        formatList(rci.dupatta_styles, 3),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Size Range",
        formatList(rt.size_range, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Adjustability",
        rt.adjustability_range,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Rental Price Range",
        rp.rental_price_range,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Security Deposit",
        rp.security_deposit_required,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Deposit Amount",
        rp.deposit_amount_range,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Late Charges",
        rp.late_return_charges,
      );
      ...
      pushFeature(
        amenities,
        <FaStar />,
        "Daily Trial Capacity",
        rsc.daily_trial_capacity,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Rental Capacity",
        rsc.simultaneous_rentals,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Payment Modes",
        formatList(rw.payment_modes, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Advance Payment",
        rw.advance_payment_percentage,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Style Tags",
        formatList(rpo.style_tags, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Audience",
        formatList(rpo.audience_tags, 3),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Usage",
        formatList(rpo.usage_tags, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Price Segment",
        formatList(rpo.price_segment_tags, 2),
      );
    }

    // --- FLOWER JEWELLERY MASTER ATTRIBUTES ---
    if (
      flowerJewelleryMaster &&
      Object.keys(flowerJewelleryMaster).length > 0
    ) {
      ...
      pushFeature(
        ...
        <FaStar />,
        "Experience",
        fi.years_of_experience ? `${fi.years_of_experience} years` : "",
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Jewellery Items",
        formatList(fpc.jewellery_items, 6),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Bridal Set Available",
        fpc.bridal_set_available,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Set Includes",
        formatList(fpc.set_includes, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Fresh Flowers",
        formatList(fmt.fresh_flower_types, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Artificial Material",
        formatList(fmt.artificial_material, 3),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Style Categories",
        formatList(fsd.style_categories, 5),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Best Known For",
        formatList(fsd.best_known_for, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Suitable For",
        formatList(fsd.suitable_for, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Outfit Matching",
        fsd.outfit_matching_support,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Customization",
        fsd.customization_available,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Design Inputs",
        formatList(fsd.custom_design_inputs, 4),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Functions",
        formatList(ffs.functions_suitable_for, 5),
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Storage Facilities",
        ff.storage_facilities,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Customization Capabilities",
        formatList(ff.customization_capabilities, 4),
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Delivery Features",
        formatList(ff.delivery_features, 4),
      );
      ...
      pushFeature(
        amenities,
        <FaStar />,
        "Bridal Set Price Range",
        fpl.bridal_set_price_range,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Bulk Orders Supported",
        fpl.bulk_orders_supported,
      );
      ...
      pushFeature(
        ...
        <FaStar />,
        "Time Slot Delivery",
        fdt.time_slot_delivery,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Early Morning Delivery",
        fdt.early_morning_delivery,
      );
      ...
      pushFeature(
        ...
        fsh.storage_instructions,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Replacement Policy",
        fsh.replacement_policy,
      );
      pushFeature(
        amenities,
        <FaStar />,
      ...
      pushFeature(
        ...
        <FaStar />,
        "Daily Capacity",
        fia.daily_order_capacity,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Advance Booking",
        fia.advance_booking_required,
      );
      pushFeature(
        amenities,
        <FaStar />,
        "Peak Season",
        fia.peak_season_availability,
      );
      ...
      pushFeature(
        ...
        <FaCalendarAlt />,
        "Advance Required",
        fwb.advance_required,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Advance Percentage",
        fwb.advance_percentage,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
        "Cancellation Policy",
        fwb.cancellation_policy,
      );
      pushFeature(
        amenities,
        <FaCalendarAlt />,
    ...
    const fetchVenueData = async () => {
      ...
      try {
        ...
        try {
          ...
          console.debug(
            "Direct slug lookup not found, trying keyword search fallback...",
            directErr?.message,
          );
        }
        ...
        if (!data) {
          ...
          const staticMatch =
            (subVenuesData || []).find((v) => {
              const vSlug = String(v.slug || v.name || "")
                .toLowerCase()
                .replace(/[^a-z0-9]/g, "");
              return (
                vSlug.includes(cleanSlugStr) || cleanSlugStr.includes(vSlug)
              );
            }) ||
          ...
          if (staticMatch) {
            data = {
              ...
              attributes: {
                ...
                rooms: staticMatch.capacity
                  ? Math.round(staticMatch.capacity / 20)
                  : 25,
        ...
        if (data.media) {
          if (Array.isArray(data.media)) {
            ...
            Array.isArray(data.media.gallery)
          ) {
            parsedImages = data.media.gallery
              .map((item) =>
                typeof item === "string" ? item : item.url || item.path || null,
              )
              .filter(Boolean);
  ...
  useEffect(() => {
    const fetchFaqData = async () => {
      ...
      const dynamicVendorId =
        ...
        venueData.userId ||
        venueData.id;
      const dynamicVendorTypeId =
        Number(
          venueData.vendor?.vendorType?.id ||
            venueData.vendor?.vendor_type_id ||
            venueData.vendor_type_id ||
            venueData.attributes?.vendor_type_id,
        ) || null;

      const subcategoryName =
        venueData.vendor?.vendorSubcategory?.name ||
        venueData.attributes?.vendor_subcategory ||
        venueData?.subcategory?.name ||
        venueData.attributes?.vendor_subcategory_name ||
        venueData.attributes?.subcategory_name ||
        "";
      const normalizedSub = String(subcategoryName).toLowerCase();
      const isLocMaster =
        venueData.attributes?.pre_wedding_location_master &&
        Object.keys(venueData.attributes.pre_wedding_location_master).length >
          0;
      const isPhotoMaster =
        venueData.attributes?.pre_wedding_photographer_master &&
        Object.keys(venueData.attributes.pre_wedding_photographer_master)
          .length > 0;
      const isDjMaster =
        venueData.attributes?.dj_master &&
        Object.keys(venueData.attributes.dj_master).length > 0;
      const isChoreoMaster =
        venueData.attributes?.sangeet_choreographer_master &&
        Object.keys(venueData.attributes.sangeet_choreographer_master).length >
          0;
      const isEntMaster =
        venueData.attributes?.wedding_entertainer_master &&
        Object.keys(venueData.attributes.wedding_entertainer_master).length > 0;
      ...
      const isSherwaniVendor =
        normalizedSub.includes("sherwani") ||
      ...
      if (
        (dynamicVendorTypeId === 22 || dynamicVendorTypeId === 11) &&
        isSherwaniVendor
      ) {
        vendorTypeKey = "groomwear";
      } else if (
        normalizedSub.includes("flower jewellery") ||
        normalizedSub.includes("floral jewellery") ||
        normalizedSub.includes("flower jewelry") ||
        normalizedSub.includes("floral jewelry")
      ) {
        vendorTypeKey = "flowerjewellery";
      } else if (
        normalizedSub.includes("kanjeevaram") ||
        normalizedSub.includes("silk saree")
      ) {
        vendorTypeKey = "kanjeevaramsilksaree";
      } else if (
        normalizedSub.includes("rental outfit") ||
        normalizedSub.includes("lehenga on rent") ||
        normalizedSub.includes("on rent") ||
        normalizedSub.includes("rent")
      ) {
        ...
        normalizedSub.includes("jewellery rental") ||
        normalizedSub.includes("jewel rental") ||
        (normalizedSub.includes("jewell") && normalizedSub.includes("rent"))
      ) {
        vendorTypeKey = "jewelleryrental";
      } else if (
        normalizedSub.includes("cocktail gown") ||
        normalizedSub.includes("gowns")
      ) {
        vendorTypeKey = "cocktailgowns";
      } else if (
        normalizedSub.includes("trousseau packer") ||
        normalizedSub.includes("trousseau pack")
      ) {
        vendorTypeKey = "trousseaupacker";
      } else if (
        normalizedSub.includes("trousseau sarees") ||
        normalizedSub.includes("trousseau saree")
      ) {
        vendorTypeKey = "trousseausarees";
      } else if (
        normalizedSub.includes("lehenga") ||
        normalizedSub.includes("bridal outfit") ||
        normalizedSub.includes("trousseau")
      ) {
        ...
        (venueData.attributes?.name || "")
          .toLowerCase()
          .includes("invitation") ||
        (venueData.attributes?.businessName || "")
          .toLowerCase()
          .includes("favor") ||
      ...
      if (!vendorTypeKey) {
        ...
        if (dynamicVendorTypeId === 22 && isSherw) {
          ...
          venueData.vendor?.vendorType?.name === "Cocktails gowns" ||
          venueData.vendor?.vendorType?.name === "Cocktail Gowns" ||
          venueData.vendor?.vendorType?.name === "cocktails-gowns"
        ) {
          vendorTypeKey = "cocktailgowns";
        } else if (
          attrs.rental_outfit_master &&
          Object.keys(attrs.rental_outfit_master).length > 0 &&
          dynamicVendorTypeId !== 22
        ) {
          vendorTypeKey = "rentaloutfit";
        } else if (
          attrs.rental_outfit_master &&
          ...
          attrs.flower_jewellery_master &&
          Object.keys(attrs.flower_jewellery_master).length > 0
        ) {
          vendorTypeKey = "flowerjewellery";
        } else if (
          attrs.trousseau_master &&
          Object.keys(attrs.trousseau_master).length > 0
        ) {
          vendorTypeKey = "trousseaupacker";
        } else if (
          (attrs.favor_master && Object.keys(attrs.favor_master).length > 0) ||
          (attrs.gift_master && Object.keys(attrs.gift_master).length > 0) ||
          (attrs.invitation_gift_master &&
            Object.keys(attrs.invitation_gift_master).length > 0) ||
          (attrs.invitation_master &&
            Object.keys(attrs.invitation_master).length > 0)
        ) {
          vendorTypeKey = "gifts";
        } else {
          ...
          const isBridalOutfitVendor =
            attrs.bridal_outfit_master &&
            Object.keys(attrs.bridal_outfit_master).length > 0 &&
            !attrs.cocktail_gown_master?.ai_faq;

          if (
            isKanjeevaramVendor ||
            (isBridalOutfitVendor && isKanjeevaramVendor)
          ) {
            vendorTypeKey = "kanjeevaramsilksaree";
      ...
      if (!vendorTypeKey && dynamicVendorTypeId) {
        vendorTypeKey = Object.keys(FaqQuestions).find((key) => {
          ...
          if (entry.subcategory_keyword === "entertainer") {
            return (
              normalizedSub.includes("entertainment") ||
              normalizedSub.includes("entertainer") ||
              isEntMaster
            );
          }
          return true;
      ...
      if (vendorTypeKey && FaqQuestions[vendorTypeKey]) {
        ...
        if (
          dynamicVendorTypeId === 11 ||
          (dynamicVendorTypeId === 22 && vendorTypeKey === "groomwear")
        ) {
          const isSherwani = normSubcat.includes("sherwani");
          const isWeddingSuit =
            normSubcat.includes("suit") || normSubcat.includes("wedding suite");
        ...
        // 3b. Decorators / Planning (vendor_type_id: 4) filtering
          ...
          const isDecorator =
            normSubcat.includes("decorator") ||
            normSubcat.includes("decor") ||
            normSubcat.includes("event styling");
          filteredQuestions = allQuestions.filter((q) => {
            const qid = q.id;
        ...
        // 3c. Invites & Gifts (vendor_type_id: 9) filtering
          ...
          const hasTrousseauMaster =
            attrs.trousseau_master &&
            Object.keys(attrs.trousseau_master).length > 0;
          const hasGiftMaster =
            attrs.gift_master && Object.keys(attrs.gift_master).length > 0;
          const hasFavorMaster =
            attrs.favor_master && Object.keys(attrs.favor_master).length > 0;
          const hasInvitationMaster =
            attrs.invitation_master &&
            Object.keys(attrs.invitation_master).length > 0;

          // Determine vendor type with priority: master profile > subcategory name
          const isTrousseauPacker =
            hasTrousseauMaster ||
            (!hasGiftMaster &&
              !hasFavorMaster &&
              !hasInvitationMaster &&
              (normSubcat.includes("trousseau packer") ||
                normSubcat.includes("trousseau pack")));
          const isGift =
            hasGiftMaster ||
            (!hasFavorMaster &&
              !hasInvitationMaster &&
              ...
              (normSubcat === "gifts" ||
                normSubcat === "gift" ||
                normSubcat.includes("gifting") ||
                (normSubcat.includes("invitation") &&
                  normSubcat.includes("gift"))));
          const isFavor =
            hasFavorMaster ||
            (!hasGiftMaster &&
              !hasInvitationMaster &&
              !hasTrousseauMaster &&
              (normSubcat.includes("favor") || normSubcat.includes("favour")));
          const isInvitation =
            hasInvitationMaster ||
            (!hasGiftMaster &&
              !hasFavorMaster &&
        ...
        const getAiFaqFallback = (qId) => {
          if (vendorTypeKey === "jewelleryrental") {
            ...
            switch (qId) {
              case 5001:
                return ai.bridal_sets || ai.bridal_jewellery_sets;
              case 5002:
                return ai.rental_duration;
              case 5003:
                return ai.security_deposit || ai.security_deposit_required;
              case 5004:
                return ai.deposit_amount;
              case 5005:
                return ai.home_delivery || ai.home_delivery_available;
              case 5006:
                return ai.try_at_home || ai.try_at_home_service;
              case 5007:
                return (
                  ai.styling_consultation || ai.styling_consultation_available
                );
              case 5008:
                return ai.jewellery_types || ai.jewellery_types_offered;
              case 5009:
                return ai.occasions || ai.suitable_occasions;
              case 5010:
                return ai.inventory_size;
              case 5011:
                return ai.replacement || ai.replacement_available;
              case 5012:
                return ai.damage_policy;
              case 5013:
                return ai.advance_required;
              case 5014:
                return ai.cancellation || ai.cancellation_policy;
              case 5015:
                return ai.best_known_for;
              default:
                return "";
            }
            ...
            switch (qId) {
              case 4001:
                return ai.bridal_accessories || ai.bridal_accessories_available;
              case 4002:
                return ai.groom_accessories;
              case 4003:
                return ai.product_mode || ai.sale_or_rental || ai.sale_rental;
              case 4004:
                return ai.customization_available || ai.custom_orders;
              case 4005:
                return ai.price_range;
              case 4006:
                return ai.try_at_home || ai.try_at_home_available;
              case 4007:
                return (
                  ai.styling_consultation || ai.styling_consultation_available
                );
              case 4008:
                return ai.outfit_matching_support || ai.outfit_matching;
              case 4009:
                return ai.delivery_available || ai.home_delivery;
              case 4010:
                return ai.return_policy;
              case 4011:
                return ai.rental_duration;
              case 4012:
                return ai.inventory_size;
            ...
            switch (qId) {
              case 4301:
                return ai.customizable;
              case 4302:
                return ai.body_measurements;
              case 4303:
                return ai.trial_fittings;
              case 4304:
                return ai.styling_consultation;
              case 4305:
                return ai.plus_size;
              case 4306:
                return ai.delivery_outside_city;
              case 4307:
                return ai.alterations_included;
              case 4308:
                return ai.urgent_order;
              case 4309:
                return ai.premium_designer;
              case 4310:
                return ai.custom_color_fabric;
              case 4311:
                return ai.comfortable_long_events;
              case 4312:
                return ai.lightweight_options;
              case 4313:
                return ai.appointment_required;
              case 4314:
                return ai.reusable;
              case 4315:
                return ai.accessory_styling;
              default:
                return "";
            }
            ...
            switch (qId) {
              case 6001:
                return ai.customization_available;
              case 6002:
                return ai.body_measurements;
              case 6003:
                return ai.trial_fittings;
              ...
              case 6009:
                return ai.premium_designer;
              case 6010:
                return ai.blouse_dupatta_included || ai.custom_color_fabric;
              case 6011:
                return ai.comfortable_long_wear;
              case 6012:
                return ai.lightweight_options;
              case 6013:
                return ai.appointment_required;
              case 6014:
                return ai.reusable_after_wedding;
              case 6015:
                return (
                  attrs.bridal_outfit_master?.pricing_logic
            ...
            const formatList = (lst, max) =>
              Array.isArray(lst)
                ? lst.slice(0, max).join(", ")
                : String(lst || "");
            switch (qId) {
              case 7001:
                return core.fabric_options?.includes("Silk") ? "Yes" : "";
              case 7002:
                return bo.core_intelligence?.customization_depth
                  ? "Yes"
                  : ai.customization_available || "";
              case 7003:
                return "";
              case 7004:
                return pc.lehenga_types || pc.design_style;
              case 7005:
                return pl.starting_price_range || "";
              case 7006:
                return ai.blouse_dupatta_included || "";
              case 7007:
                return fs.alteration_support || "";
              case 7008:
                return formatList(bi.service_cities, 3) ||
                  pd.delivery_options?.includes("Home Delivery")
                  ? "Yes – Select Cities"
                  : "";
              case 7009:
                return "";
              case 7010:
                return core.work_types?.includes("Zari") ? "Mixed" : "";
              case 7011:
                return fs.styling_consultation || ai.styling_consultation || "";
              case 7012:
                return bi.appointment_requirement || "";
              case 7013:
                return bo.workflow_booking?.booking_advance_percent || "";
              case 7014:
                return bo.workflow_booking?.cancellation_policy || "";
              case 7015:
                return "";
              default:
                return "";
            ...
            const fia =
              attrs.flower_jewellery_master?.inventory_availability || {};
            switch (qId) {
              case 8001:
                return fi.bridal_jewellery_available || "";
              case 8002:
                return fmt.flower_type || "";
              case 8003:
                return fsd.customization_available || "";
              case 8004:
                return ffs.suitable_for || "";
              case 8005:
                return fdt.delivery_available || "";
              case 8006:
                return fdt.same_day_delivery || "";
              case 8007:
                return fdt.durability || "";
              case 8008:
                return fia.bulk_orders_supported || "";
              case 8009:
                return fsd.outfit_matching_support || "";
              case 8010:
                return fdt.preparation_time || "";
              case 8011:
                return fwb.replacement_policy || "";
              case 8012:
                return fwb.advance_required || "";
              case 8013:
                return fwb.cancellation_policy || "";
              case 8014:
                return fpl.price_range || "";
              case 8015:
                return fsd.best_known_for || "";
              default:
                return "";
            }
            ...
            switch (qId) {
              case 9001:
                return ri.bridal_lehenga_available || "Yes";
              case 9002:
                return rs.customization_alteration || "";
              case 9003:
                return rci.designer_availability || "";
              case 9004:
                return rp.security_deposit_required || "";
              case 9005:
                return rp.rental_price_range?.includes("2K–10K") ||
                  rp.rental_price_range?.includes("10K–25K")
                  ? "Yes"
                  : "";
              case 9006:
                return rs.trial_availability || "";
              case 9007:
                return rs.dry_cleaning_included || "";
              case 9008:
                return rt.size_range?.includes("XL") ||
                  rt.size_range?.includes("XXL")
                  ? "Yes"
                  : "";
              case 9009:
                return rs.rental_types?.includes("Multi-Day") ? "Yes" : "";
              case 9010:
                return rs.accessory_rental ? "Yes" : "";
              case 9011:
                return rw.booking_window?.includes("0–7") ||
                  rw.booking_window?.includes("7–30")
                  ? "Yes"
                  : "";
              case 9012:
                return rt.adjustability_range || "";
              case 9013:
                return rs.pickup_delivery_service || "";
              case 9014:
                return rci.lehenga_weight?.includes("Heavy") ? "Yes" : "";
              case 9015:
                return rw.trial_appointment_required || "";
              default:
                return "";
            }
            ...
            switch (qId) {
              case 2101:
                return ai.starting_price_edible;
              case 2103:
                return ai.starting_price_non_edible;
              case 2104:
                return ai.min_order_edible;
              case 2105:
                return ai.min_order_non_edible;
              case 2106:
                return ai.gift_types;
              case 2107:
                return Array.isArray(ai.payment_modes)
                  ? ai.payment_modes.join(", ")
                  : ai.payment_modes;
              case 2108:
                return ai.advance_booking_amount;
              case 2109:
                return ai.cancellation_policy;
              case 2110:
                return ai.starting_year;
              // Gifts AI FAQ Mapping
              case 2130:
                return ai.handle_bulk_orders;
              case 2131:
                return ai.gifts_customizable;
              case 2132:
                return ai.packaging_included;
              case 2133:
                return ai.eco_friendly_gift;
              case 2134:
                return ai.deliver_across_india;
              case 2135:
                return ai.consumable_gifts_available;
              case 2136:
                return ai.shelf_life_of_consumable;
              case 2137:
                return ai.luxury_gift_options;
              case 2138:
                return ai.handle_urgent_orders;
              case 2139:
                return ai.gift_samples_available;
              case 2140:
                return ai.branded_for_corporate;
              case 2141:
                return ai.minimum_order_quantity_required;
              case 2142:
                return ai.fragile_gift_safely_packed;
              case 2143:
                return ai.temperature_controlled_delivery;
              case 2144:
                return ai.suitable_for_all_guests;
              // Favors AI FAQ Mapping
              case 2145:
                return ai.handle_bulk_orders;
              case 2146:
                return ai.favors_customizable;
              case 2147:
                return ai.edible_favors_available;
              case 2148:
                return ai.shelf_life_of_edible;
              case 2149:
                return ai.eco_friendly_favors;
              case 2150:
                return ai.personalized_with_names;
              case 2151:
                return ai.provide_packaging;
              case 2152:
                return ai.deliver_across_india;
              case 2153:
                return ai.favors_reusable;
              case 2154:
                return ai.minimum_order_quantity_required;
              case 2155:
                return ai.handle_urgent_orders;
              case 2156:
                return ai.fragile_items_safely_packed;
              case 2157:
                return ai.match_wedding_theme;
              case 2158:
                return ai.suitable_for_kids;
              case 2159:
                return ai.premium_luxury_favors_available;
              // Invitations AI FAQ Mapping
              case 2160:
                return ai.create_digital_invites;
              case 2161:
                return ai.print_physical_cards;
              case 2162:
                return ai.invitations_customizable;
              case 2163:
                return ai.match_wedding_theme;
              case 2164:
                return ai.box_invitations_available;
              case 2165:
                return ai.handmade_paper_used;
              case 2166:
                return ai.min_order_quantity;
              case 2167:
                return ai.shipping_across_world;
              case 2168:
                return ai.handle_urgent_orders;
              case 2169:
                return ai.calligraphy_services_available;
              case 2170:
                return ai.samples_available;
              case 2171:
                return ai.designer_invitations_available;
              case 2172:
                return ai.qr_code_integration;
              default:
                return "";
            }
            ...
            switch (qId) {
              case 401:
                return Array.isArray(ai.outfit_types)
                  ? ai.outfit_types.join(", ")
                  : ai.outfit_types;
              case 402:
                return ai.customization_available;
              case 403:
                return ai.collection_type;
              case 404:
                return ai.price_range;
              case 405:
                return ai.trial_available;
              case 406:
                return ai.delivery_duration;
              case 407:
                return ai.advance_required;
              case 408:
                return ai.best_known_for;
              ...
              case 411:
                return ai.groom_sherwanis || "Yes";
              case 412:
                return ai.customization_available;
              case 413:
                return ai.rental_available;
              case 414:
                return ai.security_deposit;
              case 415:
                return ai.rental_duration;
              case 416:
                return ai.dry_cleaning_included;
              case 417:
                return ai.alterations_included;
              case 418:
                return ai.accessories_included;
              case 419:
                return ai.fabric_variety;
              case 420:
                return ai.appointment_required;
              case 421:
                return ai.urgent_delivery;
              case 422:
                return ai.international_shipping;
              case 423:
                return ai.matching_stole_pagri;
              case 424:
                return ai.luxury_premium_range;
              case 425:
                return ai.return_policy;
              // Suits & Tuxedos (426-435)
              case 426:
                return ai.suits_tuxedos || "Yes";
              case 427:
                return ai.custom_tailoring;
              case 428:
                return ai.imported_fabrics;
              case 429:
                return ai.fitting_sessions;
              case 430:
                return ai.styling_assistance;
              case 431:
                return ai.ready_to_wear;
              case 432:
                return ai.matching_accessories;
              case 433:
                return ai.maintenance_tips;
              case 434:
                return ai.alteration_support;
              case 435:
                return ai.order_timeline;
              default:
                return "";
            }
          }
  ...
  if (error || !venueData) {
    return (
      <div
        className="venue-detail-page py-5"
        style={{ minHeight: "60vh", background: "#fafafa" }}
      >
        <Container className="py-5">
          ...
          >
            ...
            >
              We couldn't locate this specific vendor profile or the listing is
  ...
  const rawCityVal =
    venueData.attributes?.city || venueData.vendor?.city || null;
  ...
  const isVenueType =
    String(venueData.attributes?.vendor_type || "")
      .toLowerCase()
      .includes("venue") ||
    String(venueData.vendor?.vendorType?.name || "")
      .toLowerCase()
      .includes("venue") ||
    String(venueData.subcategory?.name || "")
      .toLowerCase()
      .includes("venue") ||
  ...
  const reviewCountVal = parseInt(
    venueData.attributes?.review_count || venueData.attributes?.reviews || 0,
    10,
  );
  ...
  if (rawTitle.length > 60) {
    const shortName =
      activeVendor.name.length > 30
        ? `${activeVendor.name.substring(0, 27)}...`
        : activeVendor.name;
    rawTitle = isVenueType
      ? cleanCity
        ? `${shortName} — Capacity | ${cleanCity}`
        : `${shortName} | HappyWedz`
      : cleanCity
        ? `${shortName} — Portfolio | ${cleanCity}`
        : `${shortName} | HappyWedz`;
  }
    ...
    <div className="venue-detail-page">
      ...
      <StructuredData
        ...
        data={{
          ...
          capacity:
            venueData.attributes?.venue_master?.space_capacity?.max_guests,
          ...
          <Col lg={8}>
            <div className="main-image-container mb-4 position-relative">
                ...
                mainImage ? (
                  <img
                    ...
                    onError={(e) => {
                      ...
                      const nextValid = (images || []).find(
                        (img) =>
                          img &&
                          img !== mainImage &&
                          !img.includes("imageNotFound"),
                      );
                      if (nextValid) {
              ...
              <button className="favorite-btn" onClick={handleFavoriteToggle}>
                <WishlistBubble show={!!bubble?.show} added={bubble?.added} />
                {isFavorite(id) ? (
                  ...
                  <Row>
                    {featuresToRender.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`amenity-item ${isSub ? "ms-4" : ""}`}
                          >
            ...
            {activeDeal && (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(118deg, #fff1f2 0%, #f9f5f7 48%, #edf9fb 100%)",
                ...
                >
                  ...
                  >
                    {(activeDeal.startDate || activeDeal.endDate) && (
                      <span>
                        {activeDeal.startDate &&
                          `From ${formatDate(activeDeal.startDate)}`}
                        {activeDeal.startDate && activeDeal.endDate && " | "}
                        {activeDeal.endDate &&
                          `Till ${formatDate(activeDeal.endDate)}`}
                      </span>
                    )}
                  </div>
                </div>
      ...
      <SimilarServices
        ...
        currentCity={
          city || venueData?.attributes?.city || venueData?.vendor?.city
        }
      />

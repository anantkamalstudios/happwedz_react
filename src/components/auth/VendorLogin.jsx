...
const VendorLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Persist via Redux slice (it also writes to localStorage)
      dispatch(setVendorCredentials({ token, vendor }));

      // Optional: if rememberMe false, we could clear storage, but slice already saved.
      // If you want session-only, you could skip localStorage when rememberMe is false.

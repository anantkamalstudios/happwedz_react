...
// const mockVenuesByCountry = {
//     India: ["Venue A (India)", "Venue B (India)"],
//     USA: ["Venue X (USA)", "Venue Y (USA)"],
//     // add more as needed
// };
...
//         const { name, value } = e.target;
//         setFormData((prev) => ({ ...prev, [name]: value }));
//         if (errors[name]) setErrors((prev) => { const o = { ...prev }; delete o[name]; return o; });
//     };
...
//                     <form onSubmit={handleSubmit} className="needs-validation" noValidate>
//                         <div className="row g-3 mb-4">
//                             {/* input fields ... name, email, password, phone, location */}
//                             {/* Country autocomplete */}
//                             <div className="col-md-6">
//                                 <Autocomplete
//                                     apiKey={process.env.REACT_APP_GOOGLE_MAPS_API_KEY}
//                                     onPlaceSelected={onCountrySelect}
//                                     options={{
//                                         types: ["(regions)"],
...
//                     {/* Display venues if loaded */}
//                     {venues.length > 0 && (
//                         <div className="mt-4">
//                             <h5>Available Venues in {formData.country}:</h5>
//                             <ul>
//                                 {venues.map((v, idx) => (
//                                     <li key={idx}>{v}</li>
//                                 ))}
...
//                         <p className="text-muted">
//                             I have an account?{" "}
//                             <Link to="/customer-login" className="text-decoration-none fw-semibold p-2">
//                                 Login
//                             </Link>
//                         </p>
//                         <p className="text-muted">
//                             I Am Vendor?{" "}
//                             <Link to="/vendor-register" className="text-decoration-none fw-semibold p-2">
//                                 Vendor
//                             </Link>
//                         </p>
//                     </div>

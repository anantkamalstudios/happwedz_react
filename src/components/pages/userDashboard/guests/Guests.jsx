...
//     try {
//       const res = await axios.get("https://happywedz.com/api/guest-list", {
...
//         `https://happywedz.com/api/guest-list/${id}`,
//         { [field]: value },
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
...
//     try {
//       await axios.delete(`https://happywedz.com/api/guest-list/${id}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });

...
const MatrimonialRegistration = () => {
  ...
  const validateStep = (step) => {
    ...
    if (step === 1) {
      if (!formData.profileFor.trim()) newErrors.profileFor = "Profile for is required";
      if (!formData.profileType.trim()) newErrors.profileType = "Profile type is required";
              ...
              <div className="profile-details">
                <div className="row">
                  <div className="col-md-6 mb-3">
                    ...
                    {errors.profileFor && (
                      <div className="invalid-feedback">{errors.profileFor}</div>
                    )}
                  </div>
                ...
                <div className="row mb-4">
                  ...
                  {formData.brothers > 0 && (
                    <>
                      ...
                      <div className="col-md-4">
                        <label className="form-label">How many unmarried?</label>
                        <div className="btn-group w-100">
                          {[0, 1, 2, 3].map((num) => (
                            <button

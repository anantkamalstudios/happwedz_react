    ...
    <>
      ...
      <Accordion alwaysOpen flush defaultActiveKey={["0", "1"]}>
        ...
        <Accordion.Item eventKey="5">
          ...
          <Accordion.Body>
            <SelectField
              label="Do you provide bridal lehengas on rent?"
              options={YES_NO}
              value={rom.ai_faq.bridal_lehengas_on_rent}
              onChange={(v) =>
                patchRom({
                  ai_faq: { ...rom.ai_faq, bridal_lehengas_on_rent: v },
                })
              }
            />
            <SelectField
              label="Is alteration included in rental?"
              options={YES_NO}
              value={rom.ai_faq.alteration_included}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, alteration_included: v } })
              }
            />
            <SelectField
              label="Do you offer designer lehengas on rent?"
              options={YES_NO}
              value={rom.ai_faq.designer_lehengas}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, designer_lehengas: v } })
              }
            />
            <SelectField
              label="Is security deposit required?"
              options={YES_NO}
              value={rom.ai_faq.security_deposit}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, security_deposit: v } })
              }
            />
            <SelectField
              label="Can I get lehenga on rent under ₹10,000?"
              options={YES_NO}
              value={rom.ai_faq.under_10k}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, under_10k: v } })
              }
            />
            <SelectField
              label="Do you provide home trials?"
              options={YES_NO}
              value={rom.ai_faq.home_trials}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, home_trials: v } })
              }
            />
            <SelectField
              label="Is dry cleaning included in rental price?"
              options={YES_NO}
              value={rom.ai_faq.dry_cleaning_included}
              onChange={(v) =>
                patchRom({
                  ai_faq: { ...rom.ai_faq, dry_cleaning_included: v },
                })
              }
            />
            <SelectField
              label="Are plus sizes available?"
              options={YES_NO}
              value={rom.ai_faq.plus_sizes}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, plus_sizes: v } })
              }
            />
            <SelectField
              label="Can I rent lehenga for multiple days?"
              options={YES_NO}
              value={rom.ai_faq.multi_day_rental}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, multi_day_rental: v } })
              }
            />
            <SelectField
              label="Do you provide accessories with lehenga?"
              options={YES_NO}
              value={rom.ai_faq.accessories_included}
              onChange={(v) =>
                patchRom({
                  ai_faq: { ...rom.ai_faq, accessories_included: v },
                })
              }
            />
            <SelectField
              label="Is urgent rental available within 3 days?"
              options={YES_NO}
              value={rom.ai_faq.urgent_rental}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, urgent_rental: v } })
              }
            />
            <SelectField
              label="Do you allow size adjustments?"
              options={YES_NO}
              value={rom.ai_faq.size_adjustments}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, size_adjustments: v } })
              }
            />
            <SelectField
              label="Is pickup and delivery available?"
              options={YES_NO}
              value={rom.ai_faq.pickup_delivery}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, pickup_delivery: v } })
              }
            />
            <SelectField
              label="Are heavy bridal lehengas available?"
              options={YES_NO}
              value={rom.ai_faq.heavy_bridal}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, heavy_bridal: v } })
              }
            />
            <SelectField
              label="Is trial mandatory before booking?"
              options={YES_NO}
              value={rom.ai_faq.trial_mandatory}
              onChange={(v) =>
                patchRom({ ai_faq: { ...rom.ai_faq, trial_mandatory: v } })
              }
            />
          </Accordion.Body>
        </Accordion.Item>

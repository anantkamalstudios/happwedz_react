...
const EnquiryManagement = () => {
  ...
  const [filter, setFilter] = useState("all"); // all, unread, read, archived, pending, replied, booked, discarded
  ...
  const handleAction = async (inboxId, action) => {
    try {
      const res = await fetch(`${API_BASE_URL}/inbox/${inboxId}/${action}`, {
        method: "PATCH",
        headers: { Authorization: `Bearer ${vendorToken}` },
      });
      if (!res.ok) throw new Error(`Failed to ${action} lead`);
      fetchInbox(); // Refetch inbox after action
    } catch (err) {
      setError(err.message);
    }
  };
  ...
  const folders = [
    { id: "inbox", name: "Inbox", count: counts.total },
    {
      id: "unread",
      name: "Unread",
      count: counts.unread,
    ...
    { id: "read", name: "Read", count: readLeadIds.size },
    { id: "archived", name: "Archived", count: counts.archived },
  ];
                          ...
                          <div className="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div className="d-flex gap-2">
                              <button
                                ...
                                onClick={() =>
                                  handleAction(selectedLead.id, "read")
                                }
                              >
                                Mark as Read
                              </button>
                              <button
                                className="btn btn-sm btn-outline-secondary"
                                onClick={() =>
                                  handleAction(selectedLead.id, "archive")
                                }
                              >
                          ...
                          <div className="lead-actions mt-auto pt-4">
                            <div className="d-flex gap-2">
                              <button
                                className="btn btn-sm btn-outline-secondary"
                                onClick={() =>
                                  handleAction(selectedLead.id, "pending")
                                }
                              >
                                Pending
                              </button>
                              <button
                                ...
                                onClick={() =>
                                  handleAction(selectedLead.id, "replied")
                                }
                              >
                                Replied
                              </button>
                              <button
                                ...
                                onClick={() =>
                                  handleAction(selectedLead.id, "booked")
                                }
                              >
                                Booked
                              </button>
                              <button
                                ...
                                onClick={() =>
                                  handleAction(selectedLead.id, "discarded")
                                }
                              >
                                Discarded
                              </button>

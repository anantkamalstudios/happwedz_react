...
import { FaHeart, FaMapMarkerAlt, FaTag, FaCalendarAlt, FaUser, FaShareAlt, FaTimes, FaChevronLeft, FaChevronRight, FaPinterest } from "react-icons/fa";
...
const PhotographyDetails = () => {
    ...
    const similarPhotos = photosByCategory?.filter((p) => p.id !== photo.id) || [];
                ...
                <div className="container">
                    <nav aria-label="breadcrumb" className="mb-3">
                        <ol className="breadcrumb bg-transparent px-0">
                            ...
                            <li className="breadcrumb-item">
                                <Link to="/photography" className="text-decoration-none text-muted">Photography</Link>
                            </li>
                ...
                <div className="container">
                    <div className="row g-4">
                                    ...
                                    <div className="p-3 border-top">
                                        <div className="d-flex gap-2 overflow-auto pb-2">
                                            {images.map((img, index) => (
                                                <div
                                                    key={index}
                                                    className={`position-relative ${selectedImageIndex === index ? "thumbnail-selected" : ""
                                                        }`}
                                                ...
                                                >
                                                    <img
                                                        ...
                                                        style={{
                                                            ...
                                                            objectFit: "cover",
                                                            cursor: "pointer",
                                                            border: selectedImageIndex === index ? "3px solid #e91e63" : "3px solid transparent",
                                                        }}
                        ...
                        <div className="col-lg-4">
                            <div className="bg-white rounded shadow-sm p-4 sticky-top" style={{ top: "20px" }}>
                                {/* Upload Date */}
                                {photo.createdAt && (
                                ...
                                {similarPhotos.length > 0 && (
                                    <div className="mb-4">
                                        <h6 className="fw-bold mb-3">View More photos from this Album</h6>
                                        <div className="d-flex gap-2 overflow-auto pb-2">
                                            ...
                                            {similarPhotos.length > 3 && (
                                                ...
                                                >
                                                    <span className="fw-bold">+{similarPhotos.length - 3} More</span>
                                                </Link>
                                            )}
                                            <button
                                ...
                                <div className="position-relative mb-4">
                                    ...
                                    <div className="d-flex align-items-center gap-3 p-3 rounded-4 bg-light bg-opacity-50"
                                        ...
                                        <div className="d-flex align-items-center gap-2">
                                            <button
                                                className={`btn position-relative overflow-hidden ${isLiked ? "btn-pink" : "btn-light"}`}
                                                onClick={handleLike}
                                                style={{
                                                    width: "48px",
                                                    height: "48px",
                                                    ...
                                                    boxShadow: isLiked ? "0 8px 16px rgba(255, 105, 180, 0.3)" : "0 2px 8px rgba(0,0,0,0.1)"
                                                }}
                                            >
                                                <FaHeart
                                                    size={20}
                                            ...
                                            <div className="d-flex flex-column align-items-start">
                                                <span className="fw-bold" style={{ fontSize: "1.125rem", lineHeight: "1.2" }}>
                                                    {photo.likes !== undefined ? photo.likes + (isLiked ? 1 : 0) : 6}
                                                </span>
                                                <small className="text-muted" style={{ fontSize: "0.75rem" }}>likes</small>
                                            </div>
                                        </div>
                                ...
                                <div className="rounded-4 p-4 mb-4" style={{
                                    ...
                                    {photo.photographer_name && (
                                        <div className="d-flex align-items-center gap-3 mb-4 pb-3" style={{ borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
                                            ...
                                            <div className="flex-grow-1">
                                                <small className="text-uppercase fw-semibold text-muted d-block" style={{ fontSize: "0.7rem", letterSpacing: "0.5px" }}>
                                                    Photographer
                                                </small>
                                                <span className="fw-bold" style={{ fontSize: "1rem", color: "#2d3748" }}>
                                                    {photo.photographer_name}
                                                </span>
                                            </div>
                                        </div>
                                            ...
                                            >
                                                <div className="card border-0 shadow-sm h-100 hover-card">
                                                    ...
                                                    <div className="card-body p-2">
                                                        <h6 className="mb-1 text-truncate small">{item.title}</h6>
